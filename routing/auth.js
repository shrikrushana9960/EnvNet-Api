...
router.post('/blog/create', async(req,res)=>{
    try{
        const {title,image, desc, sponsered, userId, sponserId, total, first, second, third, firstapprove, secondapprove, thirdapprove} = req.body;
        const newBlog = await new BlogModel({title,image, desc, sponsered, userId, sponserId, total, first, second, third, firstapprove, secondapprove, thirdapprove});
...
router.get('/blog/post/getAll/:id', async(req,res)=>{
    try{
        const id = req.params.id;
        const posts = await Fundmodel.find({blogid:id})
